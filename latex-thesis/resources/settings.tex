...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifdigital
% Uncomment the following to use the digital version:
% \digitaltrue
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Headings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ifdigital
  \KOMAoptions{open=any, numbers=noendperiod, headings=small}
\else
  \KOMAoptions{open=right, numbers=noendperiod, headings=small}
\fi
...
\KOMAoptions{%
    ...
    % listof=numbered,    % DON'T number the list of figures and tables
